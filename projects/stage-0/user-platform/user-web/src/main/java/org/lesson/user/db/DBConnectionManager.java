...
public class DBConnectionManager {
    ...
    public Connection getConnection() {
        ...
        if ("jdbc".equalsIgnoreCase(this.type)) {
            connection = getJDBCConnection(connStr);
        } else if ("jndi".equalsIgnoreCase(this.type)) {
            connection = getJNDIConnection(connStr);
        }
    ...
    private Connection getJNDIConnection(String jndiName) {
        try {
            ...
            DataSource pool = (DataSource) context.lookup(jndiName);
