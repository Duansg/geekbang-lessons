...
import cn.org.lession.web.mvc.controller.Controller;
import cn.org.lession.web.mvc.controller.PageController;
import cn.org.lession.web.mvc.controller.RestController;
...
public class FrontControllerServlet extends HttpServlet {
     ...
     * 请求与Controller实例映射
     */
    private Map<String, Controller> controllerMapping = new HashMap<String, Controller>();

    /**
     * 请求与Controller方法映射
     */
    private Map<String, HandlerMethodInfo> handlerMethodInfoMapping = new HashMap<String, HandlerMethodInfo>();
    ...
    private Set<String> findSupportedHttpMethods(Method method) {
        Set<String> supportedHttpMethods = new LinkedHashSet<String>();
